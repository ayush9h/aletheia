        ...
        <div className="flex flex-1 flex-col items-center justify-center">
          ...
          <div className="flex w-full flex-col justify-center gap-4 sm:w-auto sm:max-w-none sm:flex-row">
            {authProviders.map((item) => (
              <Button
                key={item.id}
                className="font-paragraph shadow-xs flex cursor-pointer items-center justify-center gap-2 rounded-md border border-stone-200 bg-stone-50 text-sm text-stone-800 transition-all duration-150 ease-out hover:bg-stone-200/50 active:translate-y-px active:scale-[0.98] active:bg-stone-200"
